...
interface K2CompilerPluginConfigurationProviderOnIDE {
     ...
     */
    fun provideCompileConfigurationWithCustomOptions(original: CompilerConfiguration): CompilerConfiguration
    ...
    companion object {
        ...
        @OptIn(ExperimentalCompilerApi::class)
        fun getCompileConfigurationWithCustomOptions(
            ...
            return configurationProvider?.provideCompileConfigurationWithCustomOptions(configuration)
        }
    }
}
...
internal class DefaultParcelizeCompilerPluginConfigurationProvider: K2CompilerPluginConfigurationProviderOnIDE {
    ...
    override fun provideCompileConfigurationWithCustomOptions(original: CompilerConfiguration): CompilerConfiguration {
